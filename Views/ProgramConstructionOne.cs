...
{
    public partial class ProgramConstructionOne : Form
    {
        public ProgramConstructionOne()
        {
            InitializeComponent();
        }
        ...
        private void BtnProductAndStockHandler_Click(object sender, EventArgs e)
        {
            ModelViews.productAndStockHandler.Show();
            this.Hide(); 
        }
